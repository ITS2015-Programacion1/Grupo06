...
class Menu(pilasengine.escenas.Escena):
	def iniciar(self):
		self.menu=pilas.actores.Menu([("Iniciar",self.iniciar_juego),("Tutorial",tutorial),("Salir",Salir)])

	def iniciar_juego(self):
		self.menu.eliminar()
		pilas.escenas.iniciar()
...
class Instru(pilasengine.escenas.Escena):
	pass

class tutorial(pilasengine.escenas.Escena):
	pass

class Salir(pilasengine.escenas.Escena):
	pass

pilas.escenas.vincular(iniciar)
pilas.escenas.vincular(Instru)
